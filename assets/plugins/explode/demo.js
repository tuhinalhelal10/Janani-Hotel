(function() {
    ...
    const arrOpts = [
    //disabled the default 1st effect
        //{},
        {
            direction: 'right',
            size: 4,
            ...
            //color: '#e85577',
            color: function() {
                return Math.random() < 0.5 ? '#374853' : '#deaa86'; 
            },
    ...
    items.forEach((el, pos) => {
        ...
        const bttn2 = el.querySelector('#mspan');
        ...
        bttn2.addEventListener('click', () => {
            ...
            if ( !particles.isAnimating() && buttonVisible &&(document.getElementById("mspan").classList.contains("animate-flicker"))) {
        ...
        window.addEventListener("scroll", function(event) {
            var top = this.scrollY;
                //left =this.scrollX;
                var x = document.getElementsByClassName("logo_anim");
